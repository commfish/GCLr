#' This function connects to the Gene Conservation Lab's Oracle database Loki and creates a "LocusControl" object
#'
#' @param markersuite the pre-defined name in LOKI for the set of markers for which you want genotypes (e.g. markersuite="KenaiChinook2010_40SNPs"). This set must be pre-defined in Loki (see Eric Lardizabal).
...
#' @param password your Oracle password used to access Loki (see Eric Lardizabal if you don't have a username or password)
#'
#' @export
#'
#' @return A tibble with 6 columns: Markersuite, locusnames, Publishedlocusnames, nalleles, ploidy (2 = diploid, 1 = haploid), alleles. The tibble will be named "LocusControl"
#'
#' @examples
#'
#' CreateLocusControl.GCL(markersuite = "UCI_Chinook_GTSeq_557SNPs", locusnames = NULL, username = "awbarclay", password = "mypassword")
#'
#'

custom_comb_bayes_output <- function(groupvec, group_names, maindir, mixvec, ext = "RGN", nchains = 5, burn = 0.5, alpha = 0.1, threshhold = 5e-7, plot_trace = FALSE, ncores = 4){
  ...
  # 
  # results <- custom_comb_bayes_output(groupvec = groupvec, group_names = group_names, maindir = maindir, mixvec = mixvec, ext = "BOT", nchains = 5, burn = 0.5, alpha = 0.1, threshhold = 5e-7, plot_trace = TRUE, ncores = 8)
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

...
#' 
#' @param alle_freq_prior a one-element named list specifying the prior to be used when generating Dirichlet parameters for genotype likelihood calculations. Valid methods include "const", "scaled_const", and "empirical". See \code{?rubias::list_diploid_params()} for method details. (default: list(const_scaled = 1))
#' 

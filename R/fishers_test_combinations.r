...
#' 
#' This function generates all possible pooling tests for a list of silly codes. The output is plugged into `GCLr::fishers_test(freq = x, loci = x, tests = combos)` 
#' 

...
3)  3)  Copy via Control + C

4)  4)  Switch to ChatGPT

5)  5)  Type in the prompt above and paste the function into the chat
        window via Control + V

6)  6)  Hit enter.

7)  7)  Watch it go! a. You can click “stop generating”, if it continues
        past the header, since we don’t care about the function.

8)  8)  Add the new header into the file and manually edit it, fixing
        any issues.

9)  9)  Once finished, save.
